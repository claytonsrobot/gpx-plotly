...
def plot_3d_trails(tracks, filenames, align=False, export_html=False):
...
def main():
    ...
    parser.add_argument("--no-export", action="store_true", help="Disable HTML export")
    ...
    if tracks:
        plot_3d_trails(tracks, valid_filenames, align=args.align, export_html=not args.no_export)
    else:
